...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="card">
				<form action="{{route('admin.member_edit',['id' => $ad->id])}}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="card-body">
							<div class="col-md-12 col-edit" style="margin-bottom: 20px;">
								<h5 class="card-title" style="margin-top: 10px;">Chỉnh sửa nhân viên</h5>
							</div>
							...
							<div class="col-md-6" style="float: left;">
								...
								<div class="form-group">
									...
									<select name="position" class="form-control">
										<option value="0" @if(($ad->position) != 1) selected @endif() >Nhân viên</option>
								...
								<div class="form-group">
									...
									<select name="status" class="form-control">
										<option value="0" @if(($ad->status) != 1) selected @endif()>Mở</option>
										<option value="1" @if(($ad->status) == 1) selected @endif()>Khóa</option>
									</select>
								</div>
								<div class="form-group">
									<label class="" for="">Mật khẩu</label>
									<input type="password" class="form-control" name="password" value="{{$ad->password}}" required="required">
								...
								<div class="form-group">
									...
									<input type="password" class="form-control" name="confirm_password" value="{{$ad->password}}" required="required">
